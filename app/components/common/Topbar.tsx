    ...
    <header className="sticky top-0 z-[100] flex h-16 shrink-0 items-center gap-4 border-b border-[#f3e8d9] bg-white px-6 shadow-[0_2px_12px_rgba(232,85,32,.07)]">
      ...
      <div className="flex items-center gap-2.5 shrink-0">
        ...
        <button
          ...
          className="relative flex h-9 w-9 items-center justify-center rounded-xl border border-[#e8c8a8] bg-[#fdf3ec] text-base transition-all hover:bg-orange-500/15 hover:border-[#e85520]"
        >
          🔔
          <span className="absolute top-1 right-1 h-2 w-2 rounded-full bg-[#e85520] border-2 border-white" />
        </button>
