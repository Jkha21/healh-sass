...
export default function LoginPage() {
  ...
  return (
    /*
     * Root grid — 46/54 split on desktop, single column on mobile.
     * min-h-dvh on the grid (not children) ensures the panel column
     * is constrained to viewport height — preventing illustration bleed.
     */
        ...
        <div className="w-full max-w-[420px] animate-[fadeUp_.5s_cubic-bezier(.16,1,.3,1)_both]">
          ...
          <Button
            ...
            className={[
              ...
              /* hover */
              "hover:border-[#e85520] hover:shadow-[0_8px_24px_rgba(232,85,32,.28)] hover:-translate-y-0.5",
